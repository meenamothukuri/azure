...
func Test(t *testing.T) {
    ...
    expectedDnsId := "/subscriptions/b665dde9-99ce-4dfe-980a-60aa599d2129/resourceGroups/azgw-poc-rg-40b01000-dev-01/providers/Microsoft.Network/dnsZones/test.public"
	...
	actualDnsId := terraform.Output(t, terraformOptions, "dns_id")

	// Assert that the actual values match the expected values
	assert.Equal(t, expectedDnsId, actualDnsId)
}
